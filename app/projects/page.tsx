...
const PROJECTS_DESCRIPTION = `Projects by ${AUTHOR_NAME}, including web development and application projects.`;
      ...
      <section className="projects-page">
        <header className="projects-header">
          ...
          <p className="page-subtitle">
            A selection of projects I have built while developing my web
